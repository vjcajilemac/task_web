const SideBar = () => {
  return (
    ...
    <div className="row flex-nowrap">
        <div className="col-auto col-md-12 col-xl-12 px-sm-0 px-0 bg-dark">
            <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-h-100">
